...
# 사이드바에 탭 생성
sidebar = st.sidebar.radio("LIST", ['main', '공자', '행복관', '樂', '說', 'game', '논어전문'])
...
if sidebar == 'main':
    ...
    ** 군자와 같은 형식미 = 부정적
    ...
    st.title('게임으로 보는 행복관')
    st.subheader('질문 리스트')

    with st.expander('1. 나는 새로운 학문을 배우는 것이 설렌다.'):
        st.markdown('''
        <p><學而第一>01 <br>
        子曰, “學而時習之, 不亦說乎? 有朋自遠方來, 不亦樂乎? 人不知而不慍, 不亦君子乎?” <br>
        공자께서 말씀하셨다. “배우고 때때로 그것을 익히면 또한 기쁘지 않은가? 벗이 먼 곳에서 찾아오면 또한 즐겁지 않은가? 남이 알아주지 않아도 성내지 않는다면 또한 군자답지 않은가?”</p>
    
        <p><span style="color:gray">공자는 배우고 익히는 것에 대해서 긍정적으로 여겼다.</span></p>
        ''', unsafe_allow_html=True)

    with st.expander(' 2. 나에게 주어진 것이 밥 한 그릇과 물 한 그릇뿐이라면 행복을 느낄 수 있을까?'):
        st.markdown('''
        <p><雍也第六>09 <br>
        子曰, “賢哉, 回也! 一簞食, 一瓢飮, 在陋巷, 人不堪其憂, 回也不改其樂. 賢哉, 回也!” <br>
        공자께서 말씀하셨다. “어질도다, 회여! 한 그릇의 밥과 한 표주박의 물을 가지고 누추한 거리에 살고 있으니, 보통 사람이라면 그런 근심을 견뎌내지 못하겠지만, 회는 그 즐거움이 변치 않는구나. 어질도다, 회여!”</p>
    
        <p><span style="color:gray">곤궁하고 누추한 것은 보통 사람들이 견디기 어려워 한다고 말하고 있다. 즉, 공자는 빈곤에 대해서 부정적으로 바라보고 있다. 그러나 그 상황을 무작정 벗어나려 하지 않고, 그 속에서 즐거움을 찾는 것에 대해서는 긍정적으로 바라보고 있다. 자신이 처한 상황을 즐기는 자를 진정으로 어질다고 보았다. </span></p>
        ''', unsafe_allow_html=True)

    with st.expander('3. 나는 요즘 빠져 있는 무언가가 있다.'):
        st.markdown('''
        <p><述而第七>18 <br>
        葉公問孔子於子路, 子路不對. 子曰, “女奚不曰, 其爲人也, 發憤忘食, 樂以忘憂, 不知老之將至云爾.” <br>
        섭공이 자로에게 공자에 대하여 물었는데 자로는 대답하지 않았다. (이 말을 듣고) 공자께서 말씀하셨다. “너는 어째서 ‘그의 사람됨은 무언가에 의욕이 생기면 먹는 것도 잊고, 도를 즐기느라 근심을 잊어, 늙음이 곧 다가오는 것도 알지 못한다’고 말하지 않았느냐?”</p>
    
        <p><span style="color:gray">이 문장에서 '락'은 (도를)즐기다로 해석되고 있다. 도라는 덕목을 터득하고 나서야만 제대로 즐길 수 있는 것이다. 따라서, 무언가에 푹 빠져서 몰두하는 행위는 그것을 즐기고 있는 것이며, 진정으로 도를 터득하는 과정이라고 볼 수 있다. </span></P>
         ''', unsafe_allow_html=True)

    with st.expander('4. 나는 음주가무를 통해 스트레스를 푸는 편이다.'):
        st.markdown('''
        <p><季氏第十六>05 <br>
        孔子曰, “益者三樂, 損者三樂. 樂節禮樂, 樂道人之善, 樂多賢友, 益矣. 樂驕樂, 樂佚遊, 樂晏樂, 損矣.” <br>
        공자께서 말씀하셨다. “좋아하면 유익한 것이 세 가지가 있고 좋아하면 해로운 것이 세 가지가 있다. 예악(禮樂)의 절도를 따르기를 좋아하고, 남의 좋은 점을 말하기를 좋아하고, 현명한 벗을 많이 사귀기를 좋아하면 유익하다. 교만하게 즐기기를 좋아하고, 방탕하게 노는 데 빠지기를 좋아하고, 주색에 싸여 음란하게 놀기를 좋아하면 해롭다.”</p>
    
        <P><span style="color:gray">공자는 해로운 것 3가지에 교만하게 즐기기를 좋아하는 것, 방탕하게 노는 것, 음란하게 노는 것을 부정적으로 바라보았다.</span></p>
        ''', unsafe_allow_html=True)

    with st.expander('5. 단점이 하나 있는 친구 VS 장점이 하나 있는 친구, 어떤 친구가 더 바람직할까?'):
        st.markdown('''
        <p><季氏第十六>05 <br>
        孔子曰, “益者三樂, 損者三樂. 樂節禮樂, 樂道人之善, 樂多賢友, 益矣. 樂驕樂, 樂佚遊, 樂晏樂, 損矣.” <br>
        공자께서 말씀하셨다. “좋아하면 유익한 것이 세 가지가 있고 좋아하면 해로운 것이 세 가지가 있다. 예악(禮樂)의 절도를 따르기를 좋아하고, 남의 좋은 점을 말하기를 좋아하고, 현명한 벗을 많이 사귀기를 좋아하면 유익하다. 교만하게 즐기기를 좋아하고, 방탕하게 노는 데 빠지기를 좋아하고, 주색에 싸여 음란하게 놀기를 좋아하면 해롭다.”</p>
    
        <P><span style="color:gray">위 질문과 마찬가지로, 단점보다는 장점에 긍정적인 가치를 두고 있다. 또한, 장점 중 하나로 현명한 벗을 사귀는 것을 들고 있다. </span></p>
        ''', unsafe_allow_html=True)

    with st.expander('6. 나는 돈을 벌기 위해서라면 싫어하는 일도 할 것이다.'):
        st.markdown('''
        <p><述而第七>11 <br>
        子曰, “富而可求也, 雖執鞭之士, 吾亦爲之. 如不可求, 從吾所好.” <br>
        공자께서 말씀하셨다. “부가 만약 추구해서 얻을 수 있는 것이라면, 비록 채찍을 드는 천한 일이라도 나는 하겠다. 그러나 추구해서 얻을 수 없는 일이라면 내가 좋아하는 일을 하겠다.”</p>
        
        <p><span style="color:gray">공자는 부를 추구하는 것 자체에 대해서는 부정적으로 바라보지 않았다. 그러나 의롭지 않은 수단으로 부를 축적하는 것에 대해서는 부정적으로 보았고, 이에 쉽게 부를 축적하기는 어렵다고 판단했다. 따라서, 악착까지 돈을 버는 것에 매달리기 보다는 진정으로 자신이 좋아하는 일을 하는 것에 대해서 긍정적으로 바라보았다. </span></p>
        ''', unsafe_allow_html=True)

    with st.expander('7. 나는 실수를 하면 부끄러워 견딜 수 가 없다'):
        st.markdown('''
        <p><公冶長第五>05 <br>
        子使漆彫開仕. 對曰, “吾斯之未能信.” 子說. <br>
        공자께서 칠조개에게 벼슬살이를 시키려 하시자, 그가 말하였다. “저는 아직 그 일에 자신이 없습니다.” 이에 공자께서 기뻐하셨다.</p>
    
        <p><span style="color:gray">공자는 겸손을 미덕으로 보았다. 그렇기에 자신에게도 엄격했으며, 실수에 대해서도 엄격했을 것이다. </span></p>
        ''', unsafe_allow_html=True)

    with st.expander('8. 길을 가다가 3억을 주었다. 나의 선택은? 경찰에 신고한다.'):
        st.markdown('''
        <p><里仁第四>05 <br>
        子曰, “富與貴, 是人之所欲也, 不以其道得之, 不處也. 貧與賤, 是人之所惡也, 不以其道得之, 不去也. 君子去仁, 惡乎成名? 君子無終食之間違仁, 造次必於是, 顚沛必於是.” <br>
        공자께서 말씀하셨다. “부유함과 귀함은 사람들이 바라는 것이지만, 정당한 방법으로 얻은 것이 아니라면 그것을 누려서는 안 된다. 가난함과 천함은 사람들이 싫어하는 것이지만 부당하게 그렇게 되었다 하더라도 억지로 벗어나려 해서는 안 된다. 군자가 인을 버리고 어찌 군자로서의 명성을 이루겠는가? 군자는 밥 먹는 순간에도 인을 어기지 말아야 하고, 아무리 급한 때라도 인에 근거해야 하고, 위태로운 순간일지라도 반드시 인에 근거해야 한다.”</p>
    
        <p><span style="color:gray">이 문장은 빈부에 대한 공자의 핵심 사상을 드러낸다. 공자는 빈과 부 자체에 대해서는 긍부정의 입장을 취하고 있지는 않지만, 조건을 붙여서 가치를 부여하고 있다. 자신이 처한 긍정적 상황이 부당하다면 벗어나야 한다. 부정적인 상황에 처했다면 억지로 벗어나려고 해서는 안된다. 가난에 대해서 부정적인 모습을 보이고 있지는 않지만, 아둥바둥 가난에서 벗어나려 할 이유는 없다고 보았다. </span></p>
        ''', unsafe_allow_html=True)

    with st.expander('9. 누군가 나에게 뇌물을 주려고 한다. 이때 나는? '):
        st.markdown('''
        <p><述而第七>15 <br>
        子曰, “飯疏食飮水, 曲肱而枕之, 樂亦在其中矣. 不義而富且貴, 於我如浮雲.” <br>
        공자께서 말씀하셨다. “거친 밥을 먹고 물을 마시며 팔을 굽혀 베개 삼고 누워도 즐거움은 또한 그 가운데 있다. 외롭지 않으면서 부귀를 누리는 것은 나에게는 뜬구름과 같은 것이다.”</p>
        
        <p><span style="color:gray">공자는 기본적으로 부유함에 대해서 어떠한 가치도 부여하지 않았지만, 정의롭지 못한 수단으로 부를 축적하는 것에 대해서는 타당하지 않다고 보았다. </span></p>
        ''', unsafe_allow_html=True)

    with st.expander('10. 위대한 업적을 이룬 천재가 요절했다는 기사를 봤다. 이때 나의 생각은? '):
        st.markdown('''
        <p><述而第七>34 <br>
        子疾病, 子路請禱. 子曰, “有諸?” 子路對曰, “有之, 誄曰, ‘禱爾于上下神祇.’” 子曰, “丘之禱久矣.” <br>
        공자께서 병환이 심해지시자 자로가 기도드릴 것을 청하였다. 공자께서 말씀하셨다. “그런 선례가 있느냐?” 자로가 대답하였다. “있습니다. 뇌문에 ‘너를 위하여 하늘과 땅의 신께 기도드리노라’라고 하였습니다. 공자께서 말씀하셨다. “나는 그런 기도를 드려온 지 오래되었다.”</p>
    
        <p><span style="color:gray">인간이 기본적으로 추구하는 가치관 중 하나인 장수에 대해서 긍정적으로 생각했다. 그러나 수명은 기본적으로 인간의 노력이 아니라 하늘에 달린 것으로 생각했다. 자신의 제자 백우가 병에 걸렸을 때도 진심으로 안타까워했으며, 자신의 병세가 악화되었을 때도 하늘에 기도를 올렸다고 한다. </span></p>
        ''', unsafe_allow_html=True)
